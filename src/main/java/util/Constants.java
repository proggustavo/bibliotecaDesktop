...
public class Constants {
	...
	public static final String PLACECHOLDEDRPESQUISA = "Digite o termo para Pesquisa";
	public static final String CMBANO = "SELECIONE";
	public static final String BUSCARPORTITULO = "TITULO";
